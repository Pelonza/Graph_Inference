...
#HCp
    infile=open('HC_p_mon_per_avg_'+graphdic[graph]+'_'+str(numRuns)+'Runs', 'r')
    alg1_mon_percent=json.load(infile)
    infile.close()
    infile=open('HC_p_node_per_avg_'+graphdic[graph]+'_'+str(numRuns)+'Runs', 'r')
    alg1_node_percent=json.load(infile)
    infile.close()
    infile=open('HC_p_edge_per_avg_'+graphdic[graph]+'_'+str(numRuns)+'Runs', 'r')
    alg1_edge_percent=json.load(infile)
    infile.close()
#HCpL
    infile=open('HC_pL_mon_per_avg_'+graphdic[graph]+'_'+str(numRuns)+'Runs', 'r')
    alg1c1_mon_percent=json.load(infile)
    infile.close()
    infile=open('HC_pL_node_per_avg_'+graphdic[graph]+'_'+str(numRuns)+'Runs', 'r')
    alg1c1_node_percent=json.load(infile)
    infile.close()
    infile=open('HC_pL_edge_per_avg_'+graphdic[graph]+'_'+str(numRuns)+'Runs', 'r')
    alg1c1_edge_percent=json.load(infile)
    infile.close()
#HCpF
    infile=open('HC_pF_mon_per_avg_'+graphdic[graph]+'_'+str(numRuns)+'Runs', 'r')
    alg1c2_mon_percent=json.load(infile)
    infile.close()
    infile=open('HC_pF_node_per_avg_'+graphdic[graph]+'_'+str(numRuns)+'Runs', 'r')
    alg1c2_node_percent=json.load(infile)
    infile.close()
    infile=open('HC_pF_edge_per_avg_'+graphdic[graph]+'_'+str(numRuns)+'Runs', 'r')
    alg1c2_edge_percent=json.load(infile)
    infile.close()
#HCpLF
    infile=open('HC_pLF_mon_per_avg_'+graphdic[graph]+'_'+str(numRuns)+'Runs', 'r')
    alg1c12L_mon_percent=json.load(infile)
    infile.close()
    infile=open('HC_pLF_node_per_avg_'+graphdic[graph]+'_'+str(numRuns)+'Runs', 'r')
    alg1c12L_node_percent=json.load(infile)
    infile.close()
    infile=open('HC_pLF_edge_per_avg_'+graphdic[graph]+'_'+str(numRuns)+'Runs', 'r')
    alg1c12L_edge_percent=json.load(infile)
    infile.close()
#RP
    infile=open('RPS_mon_per_avg_'+graphdic[graph]+'_'+str(numRuns)+'Runs', 'r')
    RPD_mon_percent=json.load(infile)
    infile.close()
    infile=open('RPS_node_per_avg_'+graphdic[graph]+'_'+str(numRuns)+'Runs', 'r')
    RPD_node_percent=json.load(infile)
    infile.close()
    infile=open('RPS_edge_per_avg_'+graphdic[graph]+'_'+str(numRuns)+'Runs', 'r')
    RPD_edge_percent=json.load(infile)
    infile.close()

#RW
    if graphdic[graph]!='General Relativity':
        infile=open('RWD_mon_per_avg_'+graphdic[graph]+'_'+str(numRuns)+'Runs', 'r')
        RW_mon_percent=json.load(infile)
        infile.close()
        infile=open('RWD_node_per_avg_'+graphdic[graph]+'_'+str(numRuns)+'Runs', 'r')
        RW_node_percent=json.load(infile)
        infile.close()
        infile=open('RWD_edge_per_avg_'+graphdic[graph]+'_'+str(numRuns)+'Runs', 'r')
        RW_edge_percent=json.load(infile)
        infile.close()
#HLD_p
    infile=open('HLD_p_mon_per_avg_'+graphdic[graph]+'_'+str(numRuns)+'Runs', 'r')
    RWS_mon_percent=json.load(infile)
    infile.close()
    infile=open('HLD_p_node_per_avg_'+graphdic[graph]+'_'+str(numRuns)+'Runs', 'r')
    RWS_node_percent=json.load(infile)
    infile.close()
    infile=open('HLD_p_edge_per_avg_'+graphdic[graph]+'_'+str(numRuns)+'Runs', 'r')
    RWS_edge_percent=json.load(infile)
    infile.close()
#UBDn
    infile=open(graphdic[graph]+'_UBDn_mon_per_avg_'+graphdic[graph]+'_'+str(numRuns)+'Runs', 'r')
    UBDn_mon_percent=json.load(infile)
    infile.close()
    infile=open(graphdic[graph]+'_UBDn_node_per_avg_'+graphdic[graph]+'_'+str(numRuns)+'Runs', 'r')
    UBDn_node_percent=json.load(infile)
    infile.close()
    infile=open(graphdic[graph]+'_UBDn_edge_per_avg_'+graphdic[graph]+'_'+str(numRuns)+'Runs', 'r')
    UBDn_edge_percent=json.load(infile)
    infile.close()
    
#UBDe
    infile=open(graphdic[graph]+'_UBDe_mon_per_avg_'+graphdic[graph]+'_'+str(numRuns)+'Runs', 'r')
    UBDe_mon_percent=json.load(infile)
    infile.close()
    infile=open(graphdic[graph]+'_UBDe_node_per_avg_'+graphdic[graph]+'_'+str(numRuns)+'Runs', 'r')
    UBDe_node_percent=json.load(infile)
    infile.close()
    infile=open(graphdic[graph]+'_UBDe_edge_per_avg_'+graphdic[graph]+'_'+str(numRuns)+'Runs', 'r')
