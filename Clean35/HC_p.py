...
Original creation date: 1/25/15 by Erik.
...
class Alg():
    '''
    Algorithm: Hill-Climbing wirh Probablistic Restart(HC_p)
        Old Name: Algorithm 3/HighestLocalDegree_wRestart_broken
...
'''
    ...
    def place_next_monitor(self, node, prob):
        ...
        for neighbor in neighbors:
            ...
            #This probably should be added to "add_neighbors" for consistency.
            # Since it operates on neighbors, and is maintained in class (self).
