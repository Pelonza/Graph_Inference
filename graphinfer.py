...
def main(args):
    ...
    if args.printalgs:
        ...
        print "FDD_r2    : Fake-Degree Discovery. Includes restart after 2 monitors with no new nodes added"
        print "HGD_LS    : Highest Global Degree, Least Seen"
        print "HGD_LS_r2 : Highest Global Degree, Least Seen, restart after 2 with no new info."
